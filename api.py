...
class TwinState:
    ...
    def step(self) -> dict:
        ...
        throttle = clamp(float(mission["throttle"]) + transient + math.sin(elapsed * 0.45) * 2.5, 38.0, 94.0)
        ...
        vibration = clamp(0.11 + self.wear * 0.27 + injector_variation * 1.45 + misfire_intensity * 0.16 + lubrication_penalty * 0.07 + abs(math.sin(elapsed * 1.1)) * 0.018, 0.07, 0.66)
